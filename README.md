...
- [Аннотация](#аннотация) 
- [История cat](#история-cat) 
- [Использование my_cat](#использование-my-cat) 
- [Опциии my_cat](#опции-my-cat) 
- [История grep](#история-grep) 
- [Использование my_grep](#использование-my-grep) 
- [Опциии my_grep](#опции-my-grep)
